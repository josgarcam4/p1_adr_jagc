...
from square.srv import SquareNumber  # Usamos un servicio estándar para la demostración

class SquareNumberService(Node):
    def __init__(self):
        super().__init__('square_number_service')
        self.srv = self.create_service(SquareNumber, 'square_number', self.square_callback)
